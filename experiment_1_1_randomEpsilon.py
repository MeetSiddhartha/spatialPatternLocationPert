...
def main ():
    ...
    for i in range(len(frequency_1)):
        ...
        reportedLocation_Laplace = perturbation_tool.perturbationOnOneLocation_randomEpsilon(oneDimensionLocation,
                                                                                             frequency_1[i], dimension,
                                                                                             Epsilon_list)
        reportedLocation_distPreserving = perturbation_tool.perturbationOnOneLocation_patternPreserving_randomEpsilon(
